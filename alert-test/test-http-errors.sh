...
# Test script to trigger WeatherMapHigh5xxRate alert using k6
# Alert threshold: 5xx rate > 0.05 req/s for 2 minutes

set -e

echo "=========================================="
echo "Testing: WeatherMapHigh5xxRate Alert"
echo "=========================================="
echo ""
...
echo "   VUs: 10 concurrent users"
echo "   Target: Generate HTTP errors (80% error rate)"
echo ""

k6 run --env BASE_URL=http://localhost:3001 k6-http-errors.js

echo ""
echo "✅ Load test completed!"
echo ""
echo "Expected behavior:"
echo "  - High rate of 4xx/5xx errors generated"
echo "  - Alert 'WeatherMapHigh5xxRate' should fire after 2 minutes"
echo ""
echo "Monitor alerts:"
...
echo "  Query: rate(http_requests_total{namespace=\"weather-map\",status=~\"5..\"}[5m])"
